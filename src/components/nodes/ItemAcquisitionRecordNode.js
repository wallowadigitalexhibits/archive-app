...
class ItemAcquisitionRecordNode extends Component {
  ...
  render() {
    ...
    switch (layout) {
      case 'obj':
        return (<div className="node__itemacquisitionrecord__wrapper">
                  <div className="node__itemacquisitionrecord__header" 
                       style={{ color: color,
                                borderBottom: border }}>
                  ...
                  <div className="node__itemacquisitionrecord__content">
                    <div className="node__itemacquisitionrecord__flex-column node__itemacquisitionrecord__flex-left-column">
                      <div>
                        <div className="node__itemacquisitionrecord__form-label" style={{ color: color }}>strText</div>
                        <div style={{ fontSize: '22px' }}>{node['label_props']['strText']}</div>
                      </div>
                      <div>
                        <div className="node__itemacquisitionrecord__form-label" style={{ color: color }}>
                      ...
                      <div>
                        <div className="node__itemacquisitionrecord__form-label" style={{ color: color }}>relRelatedNodes</div>
                        <div>related nodes</div>
                      </div>
                      <div>
                        <div className="node__itemacquisitionrecord__form-label" style={{ color: color }}>relRelatedProjects</div>
                    ...
                    <div className="node__itemacquisitionrecord__flex-column">
                      <div>
                        <div className="node__itemacquisitionrecord__form-label" style={{ color: color }}>boolIsDone</div>
      ...
      case 'listitem':
        return (<div className="node__itemacquisitionrecord__listitem" 
...
export default ItemAcquisitionRecordNode;
